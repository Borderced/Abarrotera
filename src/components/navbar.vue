    ...
    <div class="container">
        ...
        <nav class="navbar">
            ...
            <ul v-show="!isSidebarCollapsed">
                ...
                <li>
                    <RouterLink to="/Empleados"><span class="material-icons">person</span>Empleados</RouterLink>
                </li>
                <li>
                    <RouterLink to="/Inventario"><span class="material-icons">inventory</span>Inventario</RouterLink>
                </li>
            </ul>
