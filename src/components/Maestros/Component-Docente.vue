  ...
  <div class="syste-panel">
    <div class="panel">
      ...
      <table class="docentes-table" v-if="!mostrarFormulario && !mostrarFormularioActualizar">
        ...
        <tbody>
          <tr v-for="docente in Docentes" :key="docente.ID_PRODUCTO">
            <td>{{ docente.ID_PRODUCTO }}</td>
            <td>{{ docente.NOMBRE_PRODUCTO }}</td>
            <td>{{ docente.PRECIO_VENTA }}</td>
            <td>{{ docente.PRECIO_COMPRA }}</td>
            <td>{{ docente.STOCK }}</td>
            ...
            <td class="actions">
              ...
              <button 
                @click="eliminarDocentePorId(docente.ID_PRODUCTO)" 
