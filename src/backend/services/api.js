...
export const alta_alumno = async (id_empleado, nombre, rol, usuario, contrasena) => {
  try {
...
export const alta_docente = async (id_producto, nombre_producto, precio_venta, precio_compra, stock, fecha_registro) => {
  try {
